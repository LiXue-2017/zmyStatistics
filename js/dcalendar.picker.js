...
function ($) {
	...
	DCalendar = function (elem, options) {
		...
		if (options.mode === 'calendar')
			...
			this.tHead = $('<thead><tr><th id="prev">&lsaquo;</th><th colspan="5" id="currM"></th><th id="next">&rsaquo;</th></tr><tr><th>S</th><th>M</th><th>111</th><th>W</th><th>T</th><th>F</th><th>S</th></tr></thead>');
	...
	DCalendar.prototype = {
		...
		create: function (mode) {
			...
			if (mode === "days") {
				...
				// var sysDate = "今天: " + daysofweek[that.today.getDay()] + ", "+ months[that.today.getMonth()] + " " + that.today.getDate() + ", " + that.today.getFullYear();
				var sysDate = "今天: " + that.today.getFullYear() + "年 " + months[that.today.getMonth()] + "月 " + that.today.getDate() + "日 " + daysofweek[that.today.getDay()];
